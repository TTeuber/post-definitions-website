  ...
  return (
    <div className={"overflow-hidden lg:w-3/4 mx-auto"}>
      <div className={"uppercase"}>
        ...
        <div className={"bg-gold-200/20 dark:bg-blue-600/20 flex flex-col justify-between text-center max-lg:px-[10%] gap-10 p-8 text-2xl shadow-xl border border-blue"}>
      ...
      <div className={"flex flex-col gap-6 mb-6 relative"}>
        ...
        {data.data?.res?.items?.slice(first, last+1).map((video, idx) => {
          return (
            <div key={idx} >
              <div className={"grid grid-cols-[18rem_auto] grid-rows-[6rem_auto] max-md:grid-rows-[12rem_auto] max-sm:flex flex-col p-5 bg-blue-200/20 hover:bg-blue-400/30 dark:bg-blue-800/20 dark:hover:bg-blue-600/20 border border-blue shadow-xl"}>
